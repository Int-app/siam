  ...
  <div class="app-container">
      ...
      <el-form ref="searchFormRef" :inline="true" :model="searchData">
        <el-row>
          <el-col v-bind="base4Layout">
            <el-form-item prop="insuranceCompanyName" label="社員">
              <el-select-v2
          ...
          <el-col v-bind="base4Layout">
            <el-form-item prop="insurancecontractnumber" label="ロール">
              <el-select-v2
                v-model="searchData.insuranceCompanyName"
                :options="insuranceCompanyOptions"
                style="width: 200px"
          ...
          <el-col v-bind="base4Layout">
            <el-form-item prop="insurancecontractnumber" label="ランク">
              <el-select-v2
                v-model="searchData.insuranceCompanyName"
                :options="insuranceCompanyOptions"
                style="width: 200px"
          ...
          <el-col v-bind="base4Layout">
            <el-form-item prop="insurancecontractnumber" label="在職状態">
              <el-select-v2
                v-model="searchData.insuranceCompanyName"
                :options="insuranceCompanyOptions"
                style="width: 200px"
        ...
        <el-row>
          <el-col v-bind="base4Layout">
            <el-form-item prop="insurancecontractnumber" label="紹介社員">
              <el-select-v2
                v-model="searchData.insuranceCompanyName"
                :options="insuranceCompanyOptions"
                style="width: 200px"
    ...
    <el-card v-loading="loading" shadow="never">
      <div flex justify-between mb-3>
        <div>
          <el-button type="primary" @click="handleCreat">新規社員登録</el-button>
      ...
      <div mb-3>
        <el-table :data="tableData">
          ...
          <el-table-column prop="contractorfamilyname" label="ロール" align="center" :width="150" />
