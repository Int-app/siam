...
import { base4Layout, baseLayout, base3Layout } from "@/constants/laylout"

import AddOrEdditModal from "../company/components/Product/components/AddOrEdditModal/index.vue"
...
<template>
  <div class="app-container">
    <el-card v-loading="loading" shadow="never" class="search-wrapper">
      <el-form ref="searchFormRef" :inline="true" label-width="120px" label-position="left" :model="searchData">
        <el-row>
          <el-col v-bind="base3Layout">
    ...
    <el-card v-loading="loading" shadow="never">
      <div flex justify-between mb-3>
        <div>
          <el-button type="primary" @click="handleCreat">保険商品登録</el-button>
        </div>
      </div>
      <div mb-3>
        <el-table :data="tableData">
          ...
          <el-table-column prop="insuranceproductid" label="保険会社" align="center" :width="150" />
