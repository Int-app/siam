...
import type { AddOrEdditModalRefType, OptionType } from "../types"
import { mapDataToOption } from "../utils"
import { getInsurancecompanyList } from "@/api/insurance"
import { type FormInstance } from "element-plus"

const props = defineProps<{ addOrEdditModalRef: AddOrEdditModalRefType }>()
...
<template>
  <el-dialog v-model="visible" title="保険契約登録" @closed="resetForm" :open-delay="500" width="30%">
